                    ...
                    <div class="row">
                              ...
                              <div class="card card-full-height">
                                   <div class="card-body ">
                                        <div class="d-flex align-items-center gap-3">
                                             <img src="src/view/assets/images/food-icon/c-2.png" alt="" class="img-fluid">
                                             <div>
                         ...
                         <div class="col-md-6 col-xl-3">
                              <div class="card card-full-height">
                                   <div class="card-body ">
                                        <div class="d-flex align-items-center gap-3">
                                             <img src="src/view/assets/images/food-icon/c-5.png" alt="" class="img-fluid">
                                             <div>
                         ...
                         <div class="col-md-6 col-xl-3">
                              <div class="card card-full-height">
                                   <div class="card-body ">
                                        <div class="d-flex align-items-center gap-3">
                                             <img src="src/view/assets/images/food-icon/c-9.png" alt="" class="img-fluid">
                                             <div>
                         ...
                         <div class="col-md-6 col-xl-3">
                              <div class="card card-full-height">
                                   <div class="card-body ">
                                        <div class="d-flex align-items-center gap-3">
                                             <img src="src/view/assets/images/food-icon/c-6.png" alt="" class="img-fluid">
                                             <div>
          ...
          <script src="<?php echo BASE_URL;?>src/view/js/products.js"></script>