...
<body class="authentication-bg">
                                   ...
                                   <div class="p-3">
                                        <div class="mx-auto mb-5 auth-logo text-center">
                                             <a href="index.html" class="logo-dark">
                                                  <img src="src/view/assets/images/logo-dark.png" height="30" alt="logo dark">
                                             </a>

                                             <a href="index.html" class="logo-light">
                                                  <img src="src/view/assets/images/logo-white.png" height="30" alt="logo light">
                                             </a>
                                        </div>
                                        ...
                                        <div class="p-3">
                                             <form class="authentication-form" id="frm_login">                                                                                               
                                                  <div class="mb-4">
                                                       <label class="form-label" for="UserEmail">Email</label>
                                                       <div class="position-relative w-100">
                                                            <input type="email" class="form-control form-control-lg rounded" id="username" name="username" placeholder="Enter Email" required="">
                                                  ...
                                                  <div class="mb-4">
                                                       <a href="auth-password.html" class="float-end fw-semibold text-reset ms-1">Reset password</a>
                                                       <label class="form-label" for="UserPass">Password</label>
                                                       <div class="position-relative w-100">
                                                            <input type="password" class="form-control form-control-lg rounded" id="password" name="password" placeholder="Enter password" required="">
                                                  ...
                                                  <div class="text-center d-grid">
                                                       <button class="btn btn-primary d-flex align-items-center justify-content-center gap-1 fw-medium" type="submit" onclick="iniciar_sesion();"><i class='bx bx-log-in fs-18'></i> Sign In</button>
                                                  </div>
                                             </form>
                                        ...
                                        <p class="text-muted text-center mt-4 mb-0">Don't have an account? <a href="auth-signup.html" class="link-primary fst-italic text-decoration-underline fw-semibold">Sign up</a> </p>
                                   </div> <!-- end col -->
                              </div> <!-- end card-body -->
                         </div> <!-- end card -->
                    </div> <!-- end col -->
     ...
     <script src="src/view/assets/js/vendor.js"></script>
     <script src="src/view/assets/js/app.js"></script>
     <script src="src/view/js/sesion.js"></script>
